...
def _get_docker_base_cmd(
    ...
    extra_docker_compose_files: Optional[List[str]],
    # TODO(gp): skip_docker_image_compatibility_check.
    skip_image_compatibility_check: bool
) -> List[str]:
    r"""
    ...
    :param skip_image_compatibility_check: if True, skip checking image architecture compatibility
    """
    ...
    # explicitly skipped.
    if not (hserver.is_inside_ci() or skip_image_compatibility_check):
...
def _get_docker_compose_cmd(
    ...
    *,
    ...
    use_bash: bool = False,
    skip_image_compatibility_check: bool = False,
) -> str:
    """
    ...
    docker_cmd_ = _get_docker_base_cmd(
        ...
        extra_env_vars,
        extra_docker_compose_files,
        skip_image_compatibility_check,
    )
...
def docker_bash(  # type: ignore
    ...
    container_dir_name=".",
    skip_pull=False,
    skip_image_compatibility_check=False,
):
    """
    ...
    docker_cmd_ = _get_docker_compose_cmd(
        ...
        use_entrypoint=use_entrypoint,
        as_user=as_user,
        skip_image_compatibility_check=skip_image_compatibility_check,
    )

...
# #############################################################################
# Test_extract_github_repo_short_name
# #############################################################################


class Test_extract_github_repo_short_name(hunitest.TestCase):
    """
    Test to see if a short name of a github repo is extracted from its URL.
    """
    ...
    def test1(self) -> None:
        ...
        # Run.
        actual = hgit.extract_github_repo_short_name(input)
        # Check.
        expected = "tutorials"
...
class Test_is_repo(hunitest.TestCase):
    """
    Test to see if checking for current repository works.
    """

    def test1(self) -> None:
        """
        Check with True case.
        """
        # Run.
        actual = hgit.is_repo("helpers")
        # Check.
        expected = True
    ...
    def test2(self) -> None:
        """
        Check with False case.
        """
        # Run.
        actual = hgit.is_repo("tutorials")
        # Check.
        expected = False
        self.assertEqual(actual, expected)

...
class Test_head(hunitest.TestCase):
    def test1(self) -> None:
        ...
        # Call function to test - should not raise an exception.
        try:
            hpandas2.head(df, num_rows=2)
        except Exception as e:
            self.fail(f"head() raised an unexpected exception: {e}")
    ...
    def test2(self) -> None:
        ...
        # Call function to test with seed - should be reproducible.
        try:
            hpandas2.head(df, seed=42, num_rows=3)
        except Exception as e:
            self.fail(f"head() raised an unexpected exception: {e}")

...
class Test_JUnitReporter(hunitest.TestCase):
	"""
	Test scenario where there are passed, skipped tests with leads to `PASSED` result.
	"""
...
class Test_JUnitReporter2(hunitest.TestCase):
	"""
	Test scenario where there are passed, error, failed, and skipped tests with leads to `FAILED` result.
	"""

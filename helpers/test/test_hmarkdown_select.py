...
class Test_parse_header_string(hunitest.TestCase):
	...
	def test1(self) -> None:
		...
		# Run test.
		level, title = hmarsel.parse_header_string(header_str)
		# Check outputs.
...
class Test_find_header_by_title(hunitest.TestCase):
	...
	def test1(self) -> None:
		...
		# Run test.
		result = hmarsel.find_header_by_title(header_list, target_title)
		# Check outputs.
...
class Test_find_header_by_partial_title(hunitest.TestCase):
	...
	def test1(self) -> None:
		...
		# Run test.
		result = hmarsel.find_header_by_partial_title(header_list, partial_title)
		# Check outputs.
		self.assertIsNotNone(result)
		self.assertEqual(result.description, "Section 1.1")
	...
	def test2(self) -> None:
		...
		with self.assertRaises(AssertionError) as cm:
			hmarsel.find_header_by_partial_title(header_list, partial_title)
...
class Test_find_header_from_input(hunitest.TestCase):
	...
	def test1(self) -> None:
		...
		# Run test.
		result, level = hmarsel.find_header_from_input(header_list, header_input)
		# Check outputs.
		self.assertEqual(result.description, "Section 1.1")
		self.assertEqual(level, 2)
	...
	def test3(self) -> None:
		...
		with self.assertRaises(AssertionError):
			hmarsel.find_header_from_input(header_list, header_input)
...
class Test_find_end_line(hunitest.TestCase):
	...
	def test1(self) -> None:
		...
		# Run test.
		end_line = hmarsel.find_end_line(header_list, start_header, end_header_input)
		# Check outputs.

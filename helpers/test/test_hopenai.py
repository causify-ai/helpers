...
# #############################################################################
# Mechanism to refresh shared cache proposal
# #############################################################################

# Note: Commented code is just an idea not the final code.
...
# 4. The updated cache file should be commited to git.

# This approach best suited when
# - Cache file is used only for testing purpose.
# - we want single command to run tests and refresh cache.
...
# This approach best suited when
# - cache itself serves to reduce real API calls (and thus cut costs).
# - We need to rebuild every existing cache entry in one shot.

...
class TestDryRunTasks1(hunitest.TestCase):
    ...
    @pytest.mark.skipif(
        ...
        reason="Run only in helpers as super module. Different golden outcomes in helpers and other repos.",
    )
...
class TestDryRunTasks2(_LibTasksTestCase, _CheckDryRunTestCase):
    ...
    @pytest.mark.skipif(hgit._is_repo("cmamp"), reason="Skiping run in cmamp #11001")

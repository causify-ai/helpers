...
import config_root.config.config_builder as crcocobu
"""
...
def get_config_list_from_builder(config_builder: str) -> crcocoli.ConfigList:
    """
    ...
    hdbg.dassert_isinstance(config_list, crcocoli.ConfigList)
...
def get_notebook_config(
    *,
    ...
    if config is not None:
        ...
        config = crcocout.replace_shared_dir_paths(
...
def patch_config_list(
    config_list: crcocoli.ConfigList, experiment_list_params: Dict[str, str]
) -> crcocoli.ConfigList:
    """
    ...
    hdbg.dassert_isinstance(config_list_out, crcocoli.ConfigList)
...
def get_config_from_env() -> Optional[crococon.Config]:
    """

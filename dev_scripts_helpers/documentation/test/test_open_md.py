...
import dev_scripts_helpers.documentation.open_md as dsdoom
...
class Test_convert_ssh_to_https(hunitest.TestCase):
    ...
    def test_ssh_to_https(self) -> None:
        ...
        actual = dsdoom._convert_ssh_to_https(ssh_url)
        # Check output.
    ...
    def test_https_passthrough(self) -> None:
        ...
        expected = "https://github.com/causify-ai/helpers"
        # Call function to test.
        actual = dsdoom._convert_ssh_to_https(https_url)
        # Check output.
        self.assertEqual(actual, expected)
    ...
    def test_unknown_format_passthrough(self) -> None:
        ...
        # Call function to test.
        actual = dsdoom._convert_ssh_to_https(unknown_url)
        # Check output.
        self.assertEqual(actual, expected)
    ...
    def test_find_git_root_in_main_repo(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with open(file_path, "w") as f:
                f.write("test")
            # Call function.
            result = dsdoom._find_git_root_for_file(file_path)
            # Check result.

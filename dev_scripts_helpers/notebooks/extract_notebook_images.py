...
- Extract images from notebook `test_images.ipynb` and save them to the
...
def _run_dockerized_extract_notebook_images(
    ...
    *,
    ...
    notebook_path = docker_mount_context.convert_path(
        notebook_path,
        check_if_exists=True,
        is_input=True,
    )
    output_dir = docker_mount_context.convert_path(
        output_dir,

...
def extract_cells(notebook_path, cell_numbers, temp_notebook="temp_subset.ipynb"):
    """
    Extracts specific cells from a Jupyter Notebook and saves them as a new temporary notebook.
...
save_cells_as_png("example_notebook.ipynb", cell_numbers=[1, 3, 5], output_path="selected_cells.png")

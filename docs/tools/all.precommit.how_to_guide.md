...
- [Tools for code quality](#tools-for-code-quality)
  ...
  * [Linting](#linting)
    ...
    + [`pyrefly`](#pyrefly)
    + [`ssort`](#ssort)
  * [Call graph and dependencies](#call-graph-and-dependencies)
    + [PyCG (Practical Call Graph Generator)](#pycg-practical-call-graph-generator)
    + [code2flow](#code2flow)
    + [pycallgraph2](#pycallgraph2)
    + [py-call-graph](#py-call-graph)
    + [pyan](#pyan)
    + [`SnakeViz`](#snakeviz)
  * [Dependencies](#dependencies)
    + [`pylint pyreverse`](#pylint-pyreverse)
    + [`Pydeps`](#pydeps)
    + [`snakefood`](#snakefood)
  ...
  * [Finding dead code](#finding-dead-code)
    + [Vulture](#vulture)
  * [Detecting copy-paste](#detecting-copy-paste)
    + [`pylint symilar`](#pylint-symilar)
    + [`lizard`](#lizard-1)
    + [`jscpd`](#jscpd)
- [Linter2](#linter2)
- [Notebooks](#notebooks)

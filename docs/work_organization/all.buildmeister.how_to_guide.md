...
- The current Buildmeister must send a daily status report to eng@ at the end of each workday
  - The email subject should follow the format: `[BM Report] Build Status - YYYY-MM-DD`

...
**Example:**
Correct: “Empirical results show a 12% reduction in latency compared to the baseline.”
...
**Example:**
Correct: “We use a transformer-based architecture with multi-head attention (MHA).”
...
# Reading papers
When asked to read a paper (e.g., a Latex paper) makes sure to read all the files
included

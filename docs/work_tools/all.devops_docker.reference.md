...
- [Docker invoke flow](#docker-invoke-flow)
  ...
  * [Docker Image Tags and Registries matrix](#docker-image-tags-and-registries-matrix)
...
- In `devops/compose/`
  - [`/devops/compose/docker-compose.yml`](/devops/compose/docker-compose.yml):
    file generated by the `invoke` system based on templates, to run a Docker
    compose

...
- Follow all the conventions in `.claude/rules.md` depending on what is the type of
  file involved in the task to execute
- For example:
...
- When creating new files that belong to the repo (e.g., Python files, scripts) as
  part of the task, run `git add` but do not commit them

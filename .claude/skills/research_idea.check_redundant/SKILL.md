...
- Merge the confirmed ideas into one file using the template
  `.claude/templates/research_idea.template.md`
- Keep the file with the more complete specs (higher `Complete Specs`) as the target,
  and fold unique content from the other file(s) into it
...
- Do not drop information: if two ideas differ, keep the union of their content, not
  just one side
...
- [ ] The merged file follows `.claude/templates/research_idea.template.md`

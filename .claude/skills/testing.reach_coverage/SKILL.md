---
description: Increases unit test coverage toward 100% using a plan-then-implement approach. Use when the user wants to improve coverage for a specific file, function, or module, or when coverage gaps have been identified.
---
...
- Determine which speed suite the target tests belong to (fast/slow/superslow)
  ...
  # Replace 'fast' with 'slow' or 'superslow' if the tests are marked accordingly
  ```

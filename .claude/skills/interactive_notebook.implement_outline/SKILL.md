...
- Given the passed description for a Jupyter notebook in the format described in
  `.claude/skills/interactive_notebook.create_outline/SKILL.md` implement the cells
...
- The format is described in `.claude/skills/interactive_notebook.create_outline/SKILL.md`
...
- See `.claude/templates/interactive_notebook.template.py` for a complete
  ...
  - Integration with utility functions in

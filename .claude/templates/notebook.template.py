...
# # <PACKAGE_NAME> API
#
# - This notebook explores the <PACKAGE_NAME> library through <describe the
#   running example, e.g. the smallest example that shows the core abstraction>
# - The pedagogical arc:
#   - <Step 1: primitives>
#   - <Step 2: composition>
#   - <Step 3: patterns>
...
# Add the other third-party imports that the notebook body uses here, sorted
# alphabetically, e.g. `import numpy as np` or `import pandas as pd`.

# %%
# Import `hintros` only if the notebook body uses it.
import helpers.hintrospection as hintros
import helpers.hnotebook as hnotebook

# Replace `PACKAGE_NAME_utils` with this notebook's own paired utils module,
# always imported as `utils`, e.g. `import sklearn_distributions_utils as utils`.

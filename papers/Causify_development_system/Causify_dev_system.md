...
- [Draft](#draft)
  ...
  * [Problem statement](#problem-statement)
    + [Scalability in Development](#scalability-in-development)
    + [Consistency in Environment](#consistency-in-environment)
  ...
  * [Solution](#solution)
    + [Runnable repository and runnable directories](#runnable-repository-and-runnable-directories)
      - [Runnable repositories](#runnable-repositories)
      - [Runnable directories](#runnable-directories)
    + [Helper submodule](#helper-submodule)
    + [Thin environment](#thin-environment)
    + [Docker containers](#docker-containers)
    + [Support for Children and Sibling Containers](#support-for-children-and-sibling-containers)
    + [Executing tests](#executing-tests)
  * [Discussion/Comment](#discussioncomment)
    + [Strengths](#strengths)
    + [Comparative Advantages](#comparative-advantages)
      - [over the mono-repo approach](#over-the-mono-repo-approach)
      - [over the mono-repo approach](#over-the-mono-repo-approach-1)
